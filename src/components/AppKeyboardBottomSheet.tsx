...
import { Modal, View, Pressable, ScrollView, StyleSheet, StyleProp, ViewStyle } from 'react-native';
...
const s = StyleSheet.create({
  ...
  sheet:    { backgroundColor: '#F7F3E8', borderTopLeftRadius: 22, borderTopRightRadius: 22, paddingHorizontal: 18, paddingTop: 12 },
  sheetTablet: { width: '100%', maxWidth: 560, borderRadius: 24 },
  handle:   { width: 36, height: 4, borderRadius: 999, backgroundColor: '#DDD3BE', alignSelf: 'center', marginBottom: 14 },
