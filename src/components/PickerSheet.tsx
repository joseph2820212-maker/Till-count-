...
const ps = StyleSheet.create({
  ...
  sheet: { backgroundColor: '#F7F3E8', borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 16, paddingBottom: 26 },
  sheetTablet: { width: '100%', maxWidth: 460, borderRadius: 24 },
  handle: { width: 40, height: 4, borderRadius: 2, backgroundColor: '#DDD3BE', alignSelf: 'center', marginBottom: 10 },
  title: { fontSize: fs(11, 9, 13), fontWeight: '800', color: '#5B6476', letterSpacing: 0.8, textTransform: 'uppercase', marginBottom: 4, marginHorizontal: 4 },
