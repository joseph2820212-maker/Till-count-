...
<div style="padding:11px 14px;background:#F7F3E8;border-bottom:1px solid #DDD3BE;font-size:13px;font-weight:700;color:#1A2540;">${e(i18n.t('common.csvPreviewBanner', { count: data.length, defaultValue: '{{count}} rows' }))}</div>
