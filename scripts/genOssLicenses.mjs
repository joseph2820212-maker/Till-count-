#!/usr/bin/env node
/**
 * genOssLicenses.mjs — regenerate the open-source licence inventory for TillCount.
...
const out = `// AUTO-GENERATED — open-source licence inventory for TillCount.
...
fs.writeFileSync(OUT_TEXTS, `// AUTO-GENERATED — licence / NOTICE texts for TillCount's open-source packages (deduplicated).
// Regenerate with: node scripts/genOssLicenses.mjs  — do not hand-edit.
