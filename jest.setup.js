...
// jest-expo registers its own expo-file-system stub; use the in-memory mock so file
// round-trips (exports, backups, restores) are real in tests.
jest.mock('expo-file-system/legacy', () => jest.requireActual('./__mocks__/expo-file-system.ts'));
jest.mock('expo-file-system', () => jest.requireActual('./__mocks__/expo-file-system.ts'));
